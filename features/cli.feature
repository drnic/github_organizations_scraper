Feature: Command line interface
  ...
  Scenario: Display members of a github organization
    ...
    When I run local executable "github_organizations_scraper" with arguments "engineyard"
  ...
  Scenario: Display error for normal github user
    ...
    When I run local executable "github_organizations_scraper" with arguments "drnic"
  ...
  Scenario: Display error for non-existent github account
    When I run local executable "github_organizations_scraper" with arguments "foobar"
